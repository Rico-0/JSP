...
<script src="js/bootstrap.js"></script>
	...
	<div class="jumbotron"
		...
		<div class="container">
			<h1 class="display-3" style="margin-right: 50px; text-align:center">레시피 추천 : 식사</h1>
		</div>
	</div>
	
	<%
		RecipeDAO_food dao = RecipeDAO_food.getInstance();
		ArrayList<RecipeDto> listOfFoods = dao.getAllFoods();
	%>
		...
		<div class="row" align="center">
			<%
				for (int i = 0; i < listOfFoods.size(); i++) {
					RecipeDto food = listOfFoods.get(i);
			%>
			<div class="col-md-4">
				<img src ="./images/<%=food.getFoodImage()%>" style ="width: 100%">
				<h3 style = "margin-top:10px"><%=food.getFoodName()%></h3>
				<p><a href="./food.jsp?foodId=<%=food.getFoodId()%>" style = "margin-top:10px" class="btn btn-secondary" role="button"> 상세 정보 &raquo;</a>
			</div>
			<%
				}
			%>
